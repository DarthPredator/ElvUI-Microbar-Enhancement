...
-- L["4 rows"] = ""
-- L["6 rows"] = ""
L["Change the positioning of buttons on Microbar."] = "修改微型菜单上按钮的位置" -- Needs review
L["Hide in Combat"] = "战斗中隐藏" -- Needs review
L["Hide Microbar in combat."] = "在战斗中隐藏" -- Needs review
L["Hide microbar unless you mouse over it."] = "隐藏微型菜单, 当鼠标滑过显示."
L["Microbar"] = "微型菜单"
L["Microbar Layout"] = "微型菜单布局" -- Needs review
