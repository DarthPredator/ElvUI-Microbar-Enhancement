...
L["Use 12th button for accessing in game shop, if disabled will bring up the support panel.\n|cffFF0000Warning:|r this option requieres to reload the ui to take effect."] = "Использовать 12ю кнопку для открытия магазина. Если отключено, будет появляться панель поддержки.\n|cffFF0000Внимание:|r для вступления в силу понадобится перезагрузка интерфейса."